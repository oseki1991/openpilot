    ...
    def update(self, c, CS, frame, dragonconf):
        ...
        if c.active:
            ...
            if CS.out.standstill and frame % 5 == 0:
                ...
                can_sends.append(
                    mazdacan.create_button_cmd(self.packer, CS.CP.carFingerprint, CS.crz_btns_counter, Buttons.RESUME))
        ...
        if c.cruiseControl.cancel or (CS.out.cruiseState.enabled and not c.enabled):
            ...
            if frame % 10 == 0 and not (CS.out.brakePressed and self.brake_counter < 7):
                ...
                can_sends.append(
                    mazdacan.create_button_cmd(self.packer, CS.CP.carFingerprint, CS.crz_btns_counter, Buttons.CANCEL))
        else:
            self.brake_counter = 0
