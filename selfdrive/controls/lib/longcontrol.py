...
class LongControl:
    ...
    def update(self, active, CS, long_plan, accel_limits, t_since_plan):
        ...
        if len(speeds) == CONTROL_N:
            ...
            v_target_lower = interp(self.CP.longitudinalActuatorDelayLowerBound + t_since_plan, T_IDXS[:CONTROL_N],
                                    speeds)
            a_target_lower = 2 * (v_target_lower - v_target) / self.CP.longitudinalActuatorDelayLowerBound - a_target

            v_target_upper = interp(self.CP.longitudinalActuatorDelayUpperBound + t_since_plan, T_IDXS[:CONTROL_N],
                                    speeds)
        ...
        # tracking objects and driving
            ...
            output_accel = self.pid.update(error_deadzone, speed=CS.vEgo, feedforward=a_target,
